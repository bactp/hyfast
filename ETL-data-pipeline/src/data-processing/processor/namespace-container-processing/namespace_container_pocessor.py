...
PREFIX = "central-cluster_kube-system_container_data"
SAVED_BUCKET = "central-cluster-training"
SAVED_BUCKET_PREFIX = "central-cluster_kube-system_container_data_training"
...
def process_data(minio_client, object_name):
    ...
    """
    COLS = ['cluster_ns_container_cpu_usage',
    ...
    scaler = joblib.load("./central_cluster_ns_container_scaler.joblib")
