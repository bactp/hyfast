...
PREFIX = "central-cluster_instance_data"
SAVED_BUCKET = "central-cluster-training"
SAVED_BUCKET_PREFIX = "central-cluster_instance_data_training"
...
def push_bucket(minio_client, df, object_name):
    ...
    csv_name = f'{SAVED_BUCKET_PREFIX}/{instance}/{object_name.split("/")[1]}.csv' # central-cluster_instance_data_training/192.168.24.232:9100/20230908.csv
